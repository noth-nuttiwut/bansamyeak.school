...
import O41F1Banner from "@/public/ITABanner/B-O41.jpg"

export default async function O41SubPage({ params }: { params: { fName: string } }) {
  const {
    PdfUrls,
    ImageUrls
  ...
  return (
    <div className="flex flex-col items-center gap-4 justify-center w-full bg-gradient-to-b from-red-200 to-red-100">
      <ITABanner title="" customBanner={O41F1Banner} bgGradient="bg-gradient-to-r from-red-900 via-red-600 to-red-50" customGoto="/ITA/O41"/>
      {
