...
import O25F4Banner from "@/public/ITABanner/B-O25.jpg"

export default async function O25F4Page() {
  const {
    PdfUrls,
    ImageUrls
  } = await getUrlsFrom("4. การประเมินผลการปฏิบัติราชการ")

  return (
    <div className="flex flex-col items-center gap-4 justify-center w-full bg-gradient-to-b from-red-200 to-red-100">
      <ITABanner title="" customBanner={O25F4Banner} bgGradient="bg-gradient-to-r from-red-900 via-red-600 to-red-50" customGoto="/ITA/O25"/>
