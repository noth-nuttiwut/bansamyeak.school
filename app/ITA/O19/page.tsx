...
import O19Banner from "@/public/ITABanner/B-O19.jpg"

export default async function O19Page() {
  const {
    PdfUrls,
    ImageUrls
  } = await getUrlsFrom("O19 ")

  return (
    <div className="flex flex-col items-center gap-4 justify-center w-full bg-gradient-to-b from-red-200 to-red-100">
      <ITABanner title="" customBanner={O19Banner} bgGradient="bg-gradient-to-r from-red-900 via-red-600 to-red-50"/>
      {
