...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center min-h-fit gap-4 bg-gradient-to-b from-orange-100 to-orange-50">
      ...
      <SectionMenu key={"section-1"} items={sectionItems.section1} sectionName="ข้อมูลพื้นฐาน" bgGradient="bg-gradient-to-r from-rose-700 to-orange-500" />

      {/* section 2 : การประชาสัมพันธ์ */}
      <SectionMenu key={"section-2"} items={sectionItems.section2} sectionName="การประชาสัมพันธ์" bgGradient="bg-gradient-to-r from-orange-700 to-yellow-500" />

      {/* section 3 : การปฏิสัมพันธ์ข้อมูล */}
      <SectionMenu key={"section-3"} items={sectionItems.section3} sectionName="การปฏิสัมพันธ์ข้อมูล" bgGradient="bg-gradient-to-r from-rose-600 to-orange-400" />

      {/* section 4 : การดำเนินงาน */}
      <SectionMenu key={"section-4"} items={sectionItems.section4} sectionName="การดำเนินงาน" bgGradient="bg-gradient-to-r from-purple-600 to-pink-600" />

      {/* section 5 : การปฏิบัติงาน */}
      <SectionMenu key={"section-5"} items={sectionItems.section5} sectionName="การปฏิบัติงาน" bgGradient="bg-gradient-to-r from-purple-600 to-pink-600" />

      {/* section 6 : การให้บริการ */}
      <SectionMenu key={"section-6"} items={sectionItems.section6} sectionName="การให้บริการ" bgGradient="bg-gradient-to-r from-purple-600 to-pink-600" />

      {/* section 7 : การจัดซื้อจัดจ้าง */}
      <SectionMenu key={"section-7"} items={sectionItems.section7} sectionName="การจัดซื้อจัดจ้าง" bgGradient="bg-gradient-to-r from-teal-700 to-green-500" />

      {/* section 8 : การบริหารและพัฒนาทรัพยากรบุคคล */}
      <SectionMenu key={"section-8"} items={sectionItems.section8} sectionName="การบริหารและพัฒนาทรัพยากรบุคคล" bgGradient="bg-gradient-to-r from-rose-600 to-pink-400" />
      ...
      <SectionMenu key={"section-12"} items={sectionItems.section12} sectionName="มาตรการส่งเสริมคุณธรรมและความโปร่งใส" bgGradient="bg-gradient-to-r from-amber-600 to-yellow-500" />
